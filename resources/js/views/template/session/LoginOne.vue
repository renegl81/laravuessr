                ...
                <div class="session-content">
                    ...
                    <ValidationObserver ref="loginForm">
                        <v-form class="mb-5" @submit.prevent="">
                            ...
                            <div>
                                <v-btn type="submit" large block color="primary" class="mb-2" @click="signInWithLaravelPassport()">{{$t('message.loginNow')}}</v-btn>

                                <v-btn large block color="warning" class="mb-2" @click="signUpWithLaravelPassport()">{{$t('message.createAccount')}}</v-btn>
                            </div>
                        </v-form>
                    </ValidationObserver>
                </div>

...
export default {
    ...
    piscinas: "Pools",
    terrazas: "Terraces",
    industrialCocinas: "Industrial and Kitchen",
    piscinaTerrazaPrivada:"Private Pool & Terrace",
    piscinaHotelWellness:"Hotel & Wellness",
    piscinaDeportiva:"Sports Pool",
    piscinaPrivada:"Private Swimming Pool",
    terraza:"Pool terrace",
    cocinaIndustrial:"Industrial kitchen",
    industrialAlimentaria:"Food industrial",
    vaso: "Pool Tank",
    borde: "Pool Edge",
    rejilla: "Grid",
    sistema: "System",
    sistemaSide: "Pool system",
    colorPavimento: "Pavement color",
    formato: "Format",
    acabado: "Finish",
    piezasEspeciales: "Special pieces",
    kitchen: "Kitchen",
    kitchens: "Kitchens",
    create: "Create",
    manage: "Manage",
    Home: "Home",
    newPool: "New pool",
    webProject:"Project website",
    year:"Year",
    city:"City",
    country:"Country",
    architectWeb:"Architect website",
    architect:"Architect",
    poolMan:"Pool man",
    poolManWeb:"Pool man website",
    ...
    deleteImage: "Are you sure you want to delete the image?",
    manageProject: "Manage projects",
    imagesSaved: "Saved images",
    access: "Access",
    accept: "Accept",
    noMore: "No more projects",
    replaceImage: "Replace image",
    rosaGres:"Rosa Gres",
    rosaGresColor:"Porcelain stoneware",
    buscarProductos: "Search Products",
    colecciones: "Collections",
    terrazasExteriores: "Terraces & Outdoors",
    producto: "Product",
    productos: "Products",
    proyectos: "Projects",
    personaliza: "Personalize your Pool",
    sistemasConstructivos: "Constructive Systems",
    sistema9: "System 9",
    sistema10: "System 10",
    pavimentoIndustrial: "Industrial",
    biostop: "Biostop. Ceramic tile that eliminates bacteria",
    industrial: "Industrial",
    piscina: "Pool",
    piscinasTerrazas: "Pools and Terraces",
    industrialCocina: "Industrial and Kitchen",
    zonasProfesionales: "Professionals Area",
    downloads: "Downloads",
    acerca:"About",
    contact: "Contact",
    ...
    nosotros: "Us",
    pavimento: "Paving",
    routes_piscinas: "swimming-pools",
    routes_terrazas: "terraces",
    routes_industriel: "industrial-and-kitchen",
    types_piscinaTerrazaPrivada: "private-pool-and-terraces",
    types_piscinaHotelWellness: "pool-hotel-and-wellness",
    types_piscinaDeportiva: "sports-pool",
    types_terraza: "terrace",
    types_cocinaIndustrial: "industrial-kitchen",
    types_industrialAlimentaria: "food-industrial"
}

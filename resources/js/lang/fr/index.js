...
//rosagres
  piscinas: "Piscines",
  terrazas: "Terrasses",
  industrialCocinas: "Industriel et Cuisine",
  piscinaTerrazaPrivada: "Piscine Privée et Terrasse",
  piscinaHotelWellness: "Hotel & Wellness",
  piscinaDeportiva: "Piscine Sportive",
  piscinaPrivada:"Piscine Privée",
  terraza:"Terrasse",
  cocinaIndustrial:"Cuisine industrielle",
  industrialAlimentaria:"Industriel alimentaire",
  vaso: "Bassin",
  borde: "Bord",
  rejilla: "Grille",
  sistema: "System",
  sistemaSide: "Type de dêbordement de la piscine",
  colorPavimento: "Couleur de la chaussée",
  formato: "Format",
  acabado: "Finition",
  piezasEspeciales: "Pièces spéciales",
  kitchen: "Cuisine",
  kitchens: "Cuisines",
  create: "Créer",
  manage: "Gérer",
  Home: "Début",
  newPool: "Nouvelle piscine",
  webProject:"Site web du projet",
  year:"Année",
  city:"Ville",
  country:"Pays",
  architectWeb:"Site web du architecte",
  architect:"Architecte",
  poolMan:"Employé de piscine",
  poolManWeb:"Site web du employé de piscine",
  mainPicture:"Image principale",
  projectType: "Type de projet",
  projectSubtype: "Sous-type de projet",
  back: "Retour",
  ...
  access: "Accéder",
  accept: "Accepter",
  noMore: "Il n'y a plus de projets",
  replaceImage: "Remplacer l'image",
  rosaGres:"Rosa Gres",
  rosaGresColor:"Grès Cérame",
  buscarProductos: "Recherche Produit",
  colecciones: "Collections",
  terrazasExteriores: "Terrasses et Extérieurs",
  producto: "Produit",
  productos: "Produits",
  proyectos: "Projets",
  personaliza: "Personnalisez votre Piscine",
  sistemasConstructivos: "Système Constructif",
  sistema9: "Système 9",
  sistema10: "Système 10",
  pavimentoIndustrial: "Revêtements Industriels",
  biostop: "Biostop. La cerámique qui élimine les bactéries",
  industrial: "Industriel",
  piscina: "Piscine",
  piscinasTerrazas: "Piscines et Terrasses",
  industrialCocina: "Industriel et Coucine",
  zonasProfesionales: "Espace professionnel",
  ...
  nosotros: "Nous",
  pavimento: "Sol",
  routes_piscinas: "piscines",
  routes_terrazas: "terrasses",
  routes_industriel: "industrial-et-cuisine",
  types_piscinaTerrazaPrivada: "piscine-et-terrasse-privee",
  types_piscinaHotelWellness: "piscine-hotel-et-wellness",
  types_piscinaDeportiva: "piscine-sportive",
  types_terraza: "terrasse",
  types_cocinaIndustrial: "industriel-cuisine",
  types_industrialAlimentaria: "alimentaire-industriel"
}

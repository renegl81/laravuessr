...
export default {
    ...
    bySigningUpYouAgreeTo: 'Al registrarse, acepta',
    ...
    havingAnAccount: 'Tienes una cuenta?',
    ...
    enterYourEmailToSendYouAResetLink: "Ingrese su correo electrónico para recibir un enlace de restauración",
    ...
    piscinas: "Piscinas",
    terrazas: "Terrazas",
    industrialCocinas: "Industrial y ocinas",
    piscinaTerrazaPrivada:"Piscina y Terraza Privada",
    piscinaHotelWellness:"Piscina Hotel & Wellness",
    piscinaPrivada:"Piscina Privada",
    piscinaDeportiva:"Piscina Deportiva",
    terraza:"Terraza",
    cocinaIndustrial:"Cocina industrial",
    industrialAlimentaria:"Industria alimentaria",
    vaso: "Vaso",
    borde: "Borde",
    rejilla: "Rejilla",
    sistema: "Sistema",
    sistemaSide: "Sistema de la piscina",
    colorPavimento: "Color Pavimento",
    formato: "Formato",
    acabado: "Acabado",
    piezasEspeciales: "Piezas especiales",
    kitchen: "Cocina",
    kitchens: "Cocinas",
    create: "Crear",
    manage: "Gestionar",
    ...
    webProject:"Web del proyecto",
    year:"Año",
    city:"Ciudad",
    country:"País",
    architectWeb:"Web del arquitecto",
    architect:"Arquitecto",
    poolMan:"Piscinero",
    poolManWeb:"Web del piscinero",
    mainPicture:"Imagen principal",
    ...
    deleteImage: "¿Está seguro que desea borrar esta imagen?",
    manageProject: "Gestionar proyectos",
    imagesSaved: "Imágenes guardadas",
    access: "Acceder",
    noMore: "No hay más proyectos",
    replaceImage: "Reemplazar imágen",
    rosaGres:"Rosa Gres",
    rosaGresColor:"Gres porcelánico",
    buscarProductos: "Buscar Productos",
    colecciones: "Colecciones",
    terrazasExteriores: "Terrazas y Exteriores",
    producto: "Producto",
    productos: "Productos",
    proyectos: "Proyectos",
    personaliza: "Personaliza tu Piscina",
    sistemasConstructivos: "Sistemas Constructivos",
    sistema9: "Sistema 9",
    sistema10: "Sistema 10",
    pavimentoIndustrial: "Pavimento Industrial",
    biostop: "Biostop. La cerámica que elimina las bacterias",
    industrial: "Industrial",
    piscina: "Piscina",
    piscinasTerrazas: "Piscinas y Terrazas",
    industrialCocina: "Industrial y Cocina",
    zonasProfesionales: "Zona Profesionales",
    downloads: "Descargas",
    acerca:"Acerca de",
    contact: "Contacto",
    ...
    nosotros: "Nosotros",
    pavimento: "Pavimento",
    routes_piscinas: "piscinas",
    routes_terrazas: "terrazas",
    routes_industriel: "industrial-y-cocina",
    types_piscinaTerrazaPrivada: "piscina-y-terraza-privada",
    types_piscinaHotelWellness: "piscina-hotel-y-wellness",
    types_piscinaDeportiva: "piscina-deportiva",
    types_terraza: "terraza",
    types_cocinaIndustrial: "industrial-y-cocina",
    types_industrialAlimentaria: "industria-alimentaria"
